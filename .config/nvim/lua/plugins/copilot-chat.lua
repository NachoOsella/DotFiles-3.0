...
return {
    {
        ...
        opts = {
            prompts = prompts,
            system_prompt = "A partir de ahora, explicame todo de forma clara, paso a paso, como si estuvieras enseñándole a un estudiante universitario que recién está aprendiendo. No uses tecnicismos sin explicarlos primero, y usá ejemplos simples pero útiles. Sé didáctico, no te saltees pasos, y asegurate de que lo entienda alguien que está aprendiendo desde cero. Si hay varias formas de hacer algo, mostrámelas y explicá cuál conviene usar y por qué.",
